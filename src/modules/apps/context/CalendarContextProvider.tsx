...
const CalendarActionsContext = createContext<CalendarActionContextType>({
  setCalenderData: (data: APIDataProps<TodoType[]>) => {console.log(data);
  },
  setQueryParams: (data: object) => {console.log(data);},
  onPageChange: (
    event: React.MouseEvent<HTMLButtonElement> | null,
    data: number,
  ) => {console.log(data,event);},
  reCallAPI: () => {},
  setPage: (data: number) => {console.log(data);},
  setFilterData: (data: FilterDataType) => {console.log(data);},
});
